...
import "./globals.css";
const siteUrl = process.env.NEXT_PUBLIC_SITE_URL ?? "https://volotech.vercel.app";
export const metadata: Metadata = {
  ...
  openGraph: { title: "VoloTech.ai | Your business. In full flow.", siteName: "VoloTech.ai", description: "AI agents and connected workflows built around the tools your team already uses.", type: "website", images: [{ url: "/og-image.png", width: 1200, height: 630, alt: "VoloTech.ai. Your business. In full flow." }] },
