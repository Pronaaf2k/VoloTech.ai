...
export function ChatAssistant() {
  ...
  return <>
    <button ref={trigger} className="chat-launcher" type="button" aria-label="Open VoloTech assistant" aria-haspopup="dialog" aria-expanded={open} onClick={() => setOpen(true)}><PiChatCircleDots aria-hidden="true" /><span>Ask VoloTech</span></button>
